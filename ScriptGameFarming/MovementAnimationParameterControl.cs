...
public class MovementAnimationParameterControl : MonoBehaviour
{
    ...
    private void SetAnimationParameters(float xInput, float yInput, bool isWalking, bool isRunning, bool isIdle, bool isCarrying, ToolEffect toolEffect,
        ...
        bool isSwingingToolRight, bool isSwingingToolLeft, bool isSwingingToolUp, bool isSwingingToolDown, bool isSwingingToolUpSword, bool isSwingingToolDownSword, bool isSwingingToolRightSword, bool isSwingingToolLeftSword,
        bool idleUp, bool idleDown, bool idleLeft, bool idleRight )
    {
        ...
        if (isSwingingToolRightSword)
            animator.SetTrigger(Settings.isSwingingToolRightSword);
        if (isSwingingToolLeftSword)
            animator.SetTrigger(Settings.isSwingingToolLeftSword);
        if (isSwingingToolUpSword)
            animator.SetTrigger(Settings.isSwingingToolUpSword);
        if (isSwingingToolDownSword)
            animator.SetTrigger(Settings.isSwingingToolDownSword);
